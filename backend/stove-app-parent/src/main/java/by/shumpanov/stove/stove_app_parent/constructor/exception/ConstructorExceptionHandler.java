package by.shumpanov.stove.stove_app_parent.constructor.exception;
...
@RestControllerAdvice(basePackages = "by.shumpanov.stove.stove_app_parent.constructor")
@Slf4j
public class ConstructorExceptionHandler {
