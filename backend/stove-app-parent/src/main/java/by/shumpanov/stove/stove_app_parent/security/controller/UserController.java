...
public class UserController {
    ...
    @PutMapping("/me")
    public UserDto updateCurrentUser(@Valid @AuthenticationPrincipal UserDetails userDetails,
                                     @RequestBody UserDto userDto) {
        return userService.updateCurrentUser(userDetails.getUsername(), userDto);
    }
}
